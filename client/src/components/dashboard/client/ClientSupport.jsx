    ...
    <div className="space-y-6 pb-10">
      ...
      <div className="bg-card/40 border border-border/60 rounded-[3rem] p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 backdrop-blur-xl relative overflow-hidden group">
        ...
        <div className="relative">
          ...
          <p className="text-muted-foreground mt-2 max-w-md italic leading-relaxed">
            Get help with bookings, payments, account issues, or general inquiries. Our support team is here to assist you.
          </p>
        </div>
        <Button
          size="lg"
          className="rounded-2xl gap-2 shadow-xl shadow-sky-500/10 relative hover:scale-105 active:scale-95 transition-all"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-card/40 border border-border/60 rounded-[2rem] p-6 backdrop-blur-xl hover:bg-card/60 transition-all group">
          ...
          <a
            href="/resources/help"
            className="text-sm font-semibold text-emerald-600 flex items-center gap-2 hover:gap-3 transition-all"
          >
            Browse Articles
            <ChevronRight size={16} />
          </a>
        ...
        <div className="space-y-6">
          ...
          <section className="p-8 bg-primary/5 border border-primary/20 rounded-[2.5rem] flex flex-col gap-4">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed italic">
              For urgent matters related to active bookings or payments, please contact us directly at:
            </p>
          ...
          <section className="bg-card/40 border border-border/60 rounded-[2.5rem] p-8">
            <div className="flex items-center gap-3 text-primary mb-4">
              <FileText size={24} />
              <h3 className="text-lg font-bold">Common Topics</h3>
            </div>
            <ul className="space-y-3">
              {[
                { label: "How to book a service", link: "/resources/guides" },
                { label: "Payment methods", link: "/resources/faqs" },
                { label: "Cancellation policy", link: "/resources/help" },
                { label: "Refund process", link: "/resources/help" },
                { label: "Account verification", link: "/resources/faqs" },
              ].map((item, i) => (
                <li key={i}>
                  <a
                    href={item.link}
